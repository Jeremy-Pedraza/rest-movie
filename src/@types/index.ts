 ...
 * - bull.d.ts - Tipos para la librería Bull (queue)
 * - uuid.d.ts - Tipos para la librería uuid
 */

// Las declaraciones de tipos (.d.ts) se incluyen automáticamente
// Este archivo existe solo para referencia y documentación
