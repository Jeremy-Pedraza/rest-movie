...
export class ReportsController {
  ...
  @ApiQuery({
    name: 'metric',
    enum: ['TOTAL_SALES', 'TOTAL_REVENUE', 'ORDERS_COUNT', 'AVERAGE_TICKET'],
    required: false,
  })
  @ApiQuery({ name: 'company_id', required: false, description: 'UUID de compañía (opcional)' })
  ...
  // ============================================
  // SECCIÓN 5: ESTADÍSTICAS Y TENDENCIAS
  // ============================================
  ...
  // ============================================
  // SECCIÓN 6: ENDPOINTS POR ENTIDAD
  // ============================================
