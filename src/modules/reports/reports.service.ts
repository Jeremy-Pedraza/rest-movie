...
export class ReportsService {
  ...
  private prepareReportData(dto: CreateReportDto): any {
    return {
      ...
      total_service_charge: dto.total_service_charge || 0,
      total_payment: dto.total_payment || 0,
      ...
      // Detalles v1.1.0
      cash_summary: dto.cash_summary,
      employee_sales: dto.employee_sales,
      category_sales: dto.category_sales,
      revenue_center_sales: dto.revenue_center_sales,
      service_charges: dto.service_charges,
      income_by_class: dto.income_by_class,
      income_by_tender_type: dto.income_by_tender_type,
    };
  }
  ...
  private toResponse(report: ReportHeaderEntity): IReportResponse {
    return {
      ...
      total_service_charge: report.total_service_charge || 0,
  ...
  private toResponseWithDetails(report: ReportHeaderEntity): IReportWithDetailsResponse {
    return {
      ...
      cash_summary: report.cash_summary?.map((c) => ({
        id: c.id,
        report_header_id: c.report_header_id,
      ...
      revenue_center_sales: report.revenue_center_sales?.map((r) => ({
        id: r.id,
        report_header_id: r.report_header_id,
        revenue_center_id: r.revenue_center_id,
      ...
      income_by_class: report.income_by_class?.map((i) => ({
        id: i.id,
        report_header_id: i.report_header_id,
      ...
      income_by_tender_type: report.income_by_tender_type?.map((t) => ({
        id: t.id,
        report_header_id: t.report_header_id,
