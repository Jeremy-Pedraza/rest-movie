...
import { genresService } from '../services/crud.service';
...
function GenreForm({ initialData, onSubmit, loading, isEditing }: FormComponentProps) {
...
export default function GenresPage() {
  return <CrudPage title="Géneros" service={genresService} columns={columns} FormComponent={GenreForm} />;
}
